         ...
         if (auto scanRefsOp = mlir::dyn_cast_or_null<mlir::subop::ScanRefsOp>(op)) {
            ...
            if (currentTopLevelOp == scanRefsOp && !scanRefsOp->hasAttr("sequential")) {
               ...
               for (auto* pipelineOp : pipelineOps) {
                  ...
                  } else if (mlir::isa<mlir::subop::ANNScanOp, mlir::subop::ScanListOp, mlir::subop::CombineTupleOp, mlir::subop::GetBeginReferenceOp, mlir::subop::GetEndReferenceOp, mlir::subop::EntriesBetweenOp, mlir::subop::OffsetReferenceBy>(pipelineOp)) {
                     continue;
