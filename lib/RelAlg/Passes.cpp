...
void mlir::relalg::createQueryOptPipeline(mlir::OpPassManager& pm, runtime::Catalog* catalog) {
   ...
   pm.addNestedPass<mlir::func::FuncOp>(mlir::relalg::createANNRangeSelectionPass()); 
   pm.addNestedPass<mlir::func::FuncOp>(mlir::relalg::createANNTopKPass()); 
   pm.addNestedPass<mlir::func::FuncOp>(mlir::relalg::createPartitionByWithANNPass());
...
void mlir::relalg::registerQueryOptimizationPasses() {
   ...
   ::mlir::registerPass([]() -> std::unique_ptr<::mlir::Pass> {
      return mlir::relalg::createANNRangeSelectionPass();
   });
   ::mlir::registerPass([]() -> std::unique_ptr<::mlir::Pass> {
      return mlir::relalg::createPartitionByWithANNPass();
   });
   ::mlir::registerPass([]() -> std::unique_ptr<::mlir::Pass> {
