...
MLIR_CAPI_EXPORTED MlirType mlirDBVecTypeGet(MlirContext context, int size);
MLIR_CAPI_EXPORTED MlirTypeID mlirDBVecTypeGetTypeID();
MLIR_CAPI_EXPORTED bool mlirTypeIsADBVecType(MlirType type);
//----------------------------------------------------------------------------------------------------------------------
// RelAlg Dialect
//----------------------------------------------------------------------------------------------------------------------
