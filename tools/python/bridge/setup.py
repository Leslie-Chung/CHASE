...
pip.main(['install', '-f', '~/lingo-db/tools/python/bridge/lingodb_llvm-0.0.1-py3-none-manylinux_2_27_x86_64.manylinux_2_28_x86_64.whl', 'lingodb-llvm==0.0.1'])
pip.main(['install', 'pyarrow==14.0.1'])
import lingodbllvm
