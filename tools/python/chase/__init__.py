...
def vector_type(length=64, nullable=True):
    return {"base": "vec", "nullable": nullable, "props": [length]}
...
def metadata_from_arrow(table: pa.Table):
    ...
    for colname in schema.names:
        ...
        if t == pa.int8() or t == pa.int16() or t == pa.int32() or t == pa.int64():
            ...
            lt = vector_type(t.list_size, field.nullable)
        else:
...
class Connection:
    ...
    def get_time(self, name):
        return self.native_con.get_time(name)
